      ...
      <div className="section-container">
        ...
        <div className="writing-process-content">
          ...
          <div className="process-section partnership-section">
            ...
            <ul className="partnership-guidelines">
              <li>If your partner sends you their response first, write yours first without reading theirs beforehand.</li>
              <li>Don't send more than 10 minutes worth of writing to your partner. The idea here is to put a limit on the amount of reading each person has to do.) DO write for the full 10 minutes, even if the end is just: And then, and then, and then nothing.</li>
              <li>Only positive feedback is allowed.</li>
              <li>Every day, each person sends back the other's prompt with ONLY positive feedback attached to it. We repeat because this is one of the coolest parts of the exercise. Feedback can be in comments/in line, and/or in a response paragraph/bullet points below the piece.</li>
              <li>Read the piece more than once. Once to experience it, and again to comment.</li>
              <li>Be generous with your feedback. Golden rule mega-applies here.</li>
              <li>Try to make it as specific as possible so the other person knows what affected you, what you got from the piece, what it made you think about. What sentences you really enjoyed, or which phrases, and why.</li>
              <li>Don't lie or be dishonest to find positive feedback. Giving positive feedback can be as much of a practice as doing the writing. Really look for what you like.</li>
              <li>Do not offer your personal advice about the content ("She sounds like an asshole–break up with her!") or respond to what might (or might not) be the writer's personal life.</li>
              <li>Having trouble giving positive feedback? You might talk about the energy of the piece, or what you liked about the topic choice, or what surprised you, or made you think. Or, get really specific: "I loved your second sentence here," or, "This part made me laugh." You can also just bold or put ***s around your favorite parts.</li>
